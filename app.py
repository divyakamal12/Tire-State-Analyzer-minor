...
if file is None:
    ...
    if class_names[np.argmax(predictions)] == 'full':
        ...
        st.sidebar.markdown(
    f'<a href="https://Tire-And-Damage-minor.streamlit.app/" target="_blank" style="display: inline-block; padding: 12px 20px; background-color: black; color: white; text-align: center; text-decoration: none; font-size: 16px; border-radius: 4px;">Tire Damage Segmentation</a>',
